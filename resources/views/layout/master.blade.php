  ...
  <body class="site">
    <nav class="navbar navbar-dark bg-success">
      <a href="@auth{{route('home')}}@endauth" class="navbar-brand">
        <img src="{{asset('logo.png')}}" id="logo" alt="">
        PIES Dental Clinics
      </a>
      @auth
    ...
    <footer class="footer row" style="background-color: black;">
        <div class="col-12 col-sm-5">
          <address>Copyright © 2022 Dental Clinic Management System. All Rights Reserved</address>
        </div>
        <div class="col-12 col-sm-2">
          
        </div>
        <div class="col-12 col-sm-5">
          <address><a href="#" style="color:#b2b2d2;text-decoration:none;" id="copy_email" data-toggle="tooltip" data-placement="top" title="Click to copy">pies@gmail.com</a><br>
            <a href="http://www.itsourcecode.com" target="_blank" style="color:#b2b2d2;text-decoration:none;">www.itsourcecode.com</a>
          </address>
        </div>
    </footer>
  </body>
